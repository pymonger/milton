 ...
 * {@link #assemble()} method, which will return a temporary file that was created.
 * 
 * @author Nick
 *
 */
public class UploadReader {
	 ...
	 * @param relocRanges The Enumeration of RelocateRanges parsed from the Upload's relocStream
	 ...
	 * 
	 * 10-20/123, 100-200/789 <p/>
	 * 
	 * A few whitespaces at the beginning or end of the list are ignored, as are those surrounding the commas.
	 * 
	 * @author Nick
	 *
	 */
	 ...
	 * ByteRanges. </p>
	 * 
	 * In order for the parsing to work, the proper number of bytes must be read from each
	 * ByteRange returned by {@link #nextElement()} prior to the next invocation of {@link #hasMoreElements()}.
	 * 
	 * @author Nick
	 *
	 */
